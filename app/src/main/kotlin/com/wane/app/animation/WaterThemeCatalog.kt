...
object WaterThemeCatalog {
    ...
    private val monsoon = WaterThemeVisuals(
        themeId = "monsoon",
        wave1 = WaveParams(0x882E8CBC, 0.050f, 1.8f, 1.1f),
        wave2 = WaveParams(0x55206088, 0.040f, 2.4f, 1.5f),
        wave3 = WaveParams(0x44184870, 0.032f, 3.0f, 0.9f),
    ...
    private val glacier = WaterThemeVisuals(
        themeId = "glacier",
        wave1 = WaveParams(0x5590C8E8, 0.022f, 1.2f, 0.45f),
        wave2 = WaveParams(0x4478B0D8, 0.018f, 1.6f, 0.55f),
        wave3 = WaveParams(0x3368A0C8, 0.015f, 2.0f, 0.4f),
    ...
    private val koi = WaterThemeVisuals(
        themeId = "koi",
        wave1 = WaveParams(0x66D4A020, 0.038f, 1.6f, 0.85f),
        wave2 = WaveParams(0x44B87818, 0.030f, 2.1f, 1.0f),
        wave3 = WaveParams(0x33906010, 0.022f, 2.6f, 0.65f),
    ...
    private val bioluminescence = WaterThemeVisuals(
        ...
        wave1 = WaveParams(0x6630E8C8, 0.042f, 1.7f, 0.95f),
        wave2 = WaveParams(0x4420C8A0, 0.032f, 2.2f, 1.25f),
        wave3 = WaveParams(0x3318A878, 0.025f, 2.8f, 0.7f),
