package com.unclutteredapps.wane.service
...
import com.unclutteredapps.wane.service.di.NotificationListenerEntryPoint
import com.unclutteredapps.wane.shared.SessionState
import com.unclutteredapps.wane.util.PackageUtils
import com.unclutteredapps.wane.util.SystemPackages
...
class WaneNotificationListener : NotificationListenerService() {
    ...
    override fun onNotificationPosted(sbn: StatusBarNotification?) {
        try {
            ...
            if (sbn.packageName == "com.unclutteredapps.wane") return
    ...
    private fun shouldSnooze(sbn: StatusBarNotification): Boolean =
        sbn.packageName !in phoneAndSmsPackages &&
            ...
            sbn.packageName != "com.unclutteredapps.wane" &&
